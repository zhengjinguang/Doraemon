...
package com.lemi.mario.download.http;
...
/**
 * Subclass of the Apache {@link org.apache.http.impl.client.DefaultHttpClient} that is configured
 * with
 ...
 *
 * <p>
 * This client processes cookies but does not retain them by default. To retain cookies, simply add
 * a cookie store to the HttpContext:
 * </p>
 *
 * <pre>
 ...
 * </pre>
 */
public final class AndroidHttpClient extends HttpClientWrapper {

  // Gzip of data shorter than this probably won't be worthwhile
  public static long DEFAULT_SYNC_MIN_GZIP_BYTES = 256;

  // Default connection timeout of 20 seconds. Tweak to taste.
  ...
  public static AndroidHttpClient newInstance(String userAgent, Context context) {
    ...
    try {
      Method[] methods = SSLCertificateSocketFactory.class.getMethods();
      for (Method method : methods) {
        if (method.getName().equals("getHttpSocketFactory")) {
          Object retValue =
              method.invoke(SSLCertificateSocketFactory.class, new Object[] {
                  CONNECT_TIMEOUT, null});
          if (retValue != null && retValue instanceof SocketFactory) {
            factory = (SocketFactory) retValue;
          }
          break;
        }
      }
    ...
    if (factory != null) {
      schemeRegistry.register(new Scheme("https", factory
           ...
           * CONNECTION_TIMEOUT, nullsessionCache)
           */, 443));
    }
