...
public class MD5InputStream extends FilterInputStream {
   ...
   */
  public MD5InputStream(Context context, InputStream in) {
    super(in);
  ...
  public static void main(String[] arg) {
    try {
      ...
      // //////////////////////////////////////////////////////////////
      //
      // usage: java com.twmacinta.util.MD5InputStream [--use-default-md5] [--no-native-lib]
      // filename
      //
      // ///////
      ...
      if (use_default_md5) {
        ...
        if (!use_native_lib) {
          MD5.initNativeLibrary(null, true);// we don't have context (yangkai)
        }

        // calculate the checksum

        MD5InputStream in =
            new MD5InputStream(null, new BufferedInputStream(new FileInputStream(filename)));
        while ((num_read = in.read(buf)) != -1);
